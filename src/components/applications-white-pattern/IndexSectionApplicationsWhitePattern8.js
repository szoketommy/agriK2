...
export default function IndexSectionApplicationsWhitePattern8() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="md:absolute md:top-28 lg:top-1/2 md:-left-96 xl:-left-80 md:-ml-56 lg:-ml-20 xl:-ml-0 md:transform lg:-translate-y-1/2 px-4 mb-16 md:mb-0">
    <div className="relative max-w-max">
      <img className="absolute p-7 -mt-1 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10/12 z-20" src="flex-ui-assets/elements/dashboard.png" alt />
      <img className="relative z-10" src="flex-ui-assets/elements/applications/macbook.png" alt />
      <img className="absolute -top-24 left-0 md:mt-px md:left-96 md:ml-52 lg:ml-16 xl:-ml-20 w-28 md:w-auto text-blue-500" src="flex-ui-assets/elements/dots2-blue.svg" />
      <img className="absolute -bottom-24 right-0 md:mt-px md:left-96 md:ml-52 lg:ml-16 xl:-ml-20 w-28 md:w-auto text-red-500" src="flex-ui-assets/elements/dots2-red.svg" />
      <img className="absolute right-0 top-1/2 transform -translate-y-1/2 w-28 md:w-auto text-yellow-400" src="flex-ui-assets/elements/circle2-yellow.svg" />
    </div>
  </div>
  <div className="container px-4 mx-auto">
    <div className="md:w-1/2 md:ml-auto pl-4">
      <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium rounded-full shadow-sm">Application</span>
      <h3 className="mb-6 text-4xl md:text-5xl leading-tight text-coolGray-900 font-bold tracking-tighter">Treaba bună începe cu un PLAN si Toată lumea are un plan până când este lovită de realitate</h3>
      <p className="mb-12 text-lg md:text-xl text-coolGray-500 font-medium">Tot ce ai nevoie pentru a planifica, urmări și gestiona munca fermei tale.  concentrată pe sarcini pentru a realiza mai multe.</p>
      <div className="flex flex-wrap mb-10 text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Funcțiile integrate de programare a fermei</h3>
            <p className="text-coolGray-500 font-medium">Stay connected with your team and make quick decisions wherever you are.</p>
          </div>
        </div>
      </div>
      <div className="flex flex-wrap mb-10 text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Gestionarea sarcinilor, urmărirea muncii și a timpului</h3>
            <p className="text-coolGray-500 font-medium">A tool that lets you build a dream website even if you know nothing about web design or programming.</p>
          </div>
        </div>
      </div>
      <div className="flex flex-wrap text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Raportarea ajută la menținerea echipei fermei tale pe drumul cel bun și </h3>
            <p className="text-coolGray-500 font-medium">The first business platform to bring together all of your products from one place.</p>
          </div>
        </div>
      </div>
    </div>
