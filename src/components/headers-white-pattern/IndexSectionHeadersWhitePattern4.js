...
export default function IndexSectionHeadersWhitePattern4() {
    return (
        <React.Fragment>
            <>
    ...
    <div className="container px-4 mx-auto">
      <div className="flex flex-wrap xl:items-center -mx-4">
        <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
          ...
          <h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight">agriK: O afacere agricolă este la fel de bună precum uneltele sale. </h1>
          <p className="mb-8 text-lg md:text-xl text-coolGray-500 font-medium">"Suntem diferiți. AgriK este singura platformă de business care îți permite să îți conduci afacerea pe o singură platformă, fără probleme pe toate canalele digitale.</p>
          <div className="flex flex-wrap">
            <div className="w-full md:w-auto py-1 md:py-0 md:mr-4"><a className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 text-green-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-green-500 rounded-md shadow-sm" href="#">Solicita un DEMO</a></div>
            <div className="w-full md:w-auto py-1 md:py-0"><a className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 text-coolGray-800 font-medium text-center bg-white hover:bg-coolGray-100 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 border border-coolGray-200 rounded-md shadow-sm" href="#">Lista de asteptare</a></div>
          </div>
        </div>
        <div className="w-full md:w-1/2 px-4">
          <div className="relative mx-auto md:mr-0 max-w-max">
            ...
            <img className="relative rounded-7xl" src="https://static.shuffle.dev/uploads/files/76/7675732c1375916f878e8a31f80358b3e266836d/woman-farm-with-tablet.jpg" alt />
          </div>
        </div>
      </div>
    </div>
